...
export default {
  async getUsers(token) {
    ...
    const users = await usersHandler.postRequest('https://services7.arcgis.com/AGOpm0AOkNTcqxqa/arcgis/rest/services/users/FeatureServer/0/query?f=json&where=1=1&outSr=4326&outFields=email, role, tel, anansiCode, OBJECTID', data2, headers);
