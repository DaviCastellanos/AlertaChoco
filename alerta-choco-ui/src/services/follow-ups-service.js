...
export default {
  ...
  async save(followUp) {
    ...
    const updateResponse = await followUpHandler.postRequest(
      `https://services7.arcgis.com/AGOpm0AOkNTcqxqa/arcgis/rest/services/seguimientos/FeatureServer/0/applyEdits`,
      updateData,
      header
    );
