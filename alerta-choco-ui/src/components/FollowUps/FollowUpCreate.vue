<template>
  <div id="seguimiento">
    ...
    <b-button v-if="userIsAuthenticated" @click="this.save" size="lg" class="text-light mt-5 mb-3" variant="warning" :disabled="this.requiredFieldsCompleted" block>Crear nuevo seguimiento</b-button>
  </div>
</template>
<script>
