      ...
      <b-col>
        ...
        <div class="mt-3">
          ...
          <b-form-select
            ...
            :options="opcionesEtniaAfectados"
            multiple
            :select-size="3"
      ...
      <b-col>
        ...
        <div class="mt-3">
          ...
          <b-form-select
            ...
            :state="lengthState(categoriaEvento)"
          ></b-form-select>
        </div>
        ...
        <div class="mt-3">
          ...
          <b-form-select
            ...
            :state="lengthState(etniaVictima)"
          ></b-form-select>
        </div>
        ...
        <div class="mt-3">
          ...
          <b-form-select
            v-model="rolVictimaEnum"
            :options="opcionesRol"
            multiple
            :select-size="3"
            :state="lengthState(rolVictimaEnum)"
          ></b-form-select>
        </div>
        ...
        <div class="mt-3">
          ...
          <b-form-select
            ...
            :state="lengthState(identidadGenero)"
          ></b-form-select>
        </div>
    ...
    return {
      ...
      opcionesSubcategoria: [
        ...
        { value: "0", text: "Abuso Sexual" },
        {
          value: "1",
          text:
            "Accidente o incidente con Minas Antipersona o Municiones sin explotar",
        },
        ...
        {
          value: "32",
          text: "Uso o vinculación de niños, niñas y adolescentes",
        },
      ...
      opcionesDiscapacidad: [
        ...
        { value: "2", text: "Motora (No puede moverse con facilidad)" },
        {
          value: "3",
          text:
            "Cognitiva (No puede aprender, razonar, pensar, hablar, facilmente)",
        },
      ...
      opcionesDerechos: [
        ...
        {
          value: "0",
          text: "Gestionar la protección de otras personas o la propia",
        },
        {
          value: "1",
          text:
            "Asociarse u organizarse para la defensa de los derechos humanos",
        },
        ...
        {
          value: "4",
          text: "Promover debates y principios nuevos sobre derechos humanos",
        },
        {
          value: "5",
          text:
            "Presentar ante insituciones públicas críticas o propuestas de mejora",
        },
        {
          value: "6",
          text:
            "Denunciar las políticas y acciones oficiales y a que se examinen estas denuncias",
        },
        {
          value: "7",
          text:
            "Ofrecer y prestar asistencia para defender los derechos humanos",
        },
        {
          value: "8",
          text:
            "Asistir a las audiencias, reuniones con insituciones, procedimientos y juicios públicos",
        },
        {
          value: "9",
          text: "Dirigirse sin barreras a las ONG y a comunicarse con ellas",
        },
        {
          value: "10",
          text:
            "Contar con recursos eficaces para la protección y defensa de los derechos humanos",
        },
        {
          value: "11",
          text:
            "Ejercer legitimamente la ocupación o profesión de defensor de derechos humanos",
        },
        {
          value: "12",
          text:
