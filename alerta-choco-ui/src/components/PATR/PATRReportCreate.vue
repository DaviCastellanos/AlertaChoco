<template>
  <b-container fluid id="form">
    ...
    <b-button v-if="userAccessIsPrivate" @click="this.save" size="lg" class="text-light mt-5 mb-3" variant="warning" block :disabled="requiredFieldsCompleted()">Crear nuevo reporte PATR</b-button>
  </b-container>
</template>
<script>
